...
import CommentListItemDark from './commentListItemDark';
...
class CommentListDark extends Component {
            ...
            axios.get('https://www.googleapis.com/youtube/v3/commentThreads', {
                ...
                .then((response) => {
                    ...
                    response.data.items.forEach((comment) => {
                        ...
                        this.state.extractedComments.push(<CommentListItemDark
                            key={comment.etag}
                            video={comment} />);
                    });
...
export default CommentListDark;